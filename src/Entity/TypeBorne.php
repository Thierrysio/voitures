...
class TypeBorne
{
    ...
    private ?int $codeTypeBorne = null;
    ...
    public function getCodeTypeBorne(): ?int
    {
        return $this->codeTypeBorne;
    }

    public function setCodeTypeBorne(?int $codeTypeBorne): static
    {
    ...
    public function removeLesBorne(Borne $lesBorne): static
    {
        if ($this->lesBornes->removeElement($lesBorne)) {
            ...
            if ($lesBorne->getLeType() === $this) {
                $lesBorne->setLeType(null);
            }
        }
